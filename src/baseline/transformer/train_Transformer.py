...
resume_path = 'saved/Transformer/Epoch_0_JA_0.4337_DDI_0.1658.model'
...
def main(args):
    ...
    model = Transformer(voc_size, emb_dim=args.emb_dim, feature_size=args.feature_size, device=device)
    ...
    for epoch in range(start_epoch, EPOCH):
        ...
        for idx, data in enumerate(train_dataloader):
            ...
            output_logits = model(dis_med, adm_med, pre_med, diag, proc, dis_mask, adm_mask, pre_mask, diag_mask, proc_mask)
