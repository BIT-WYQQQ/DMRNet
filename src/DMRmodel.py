...
class MedTransformerDecoder(nn.Module):
    ...
    def forward(self, input_medication_embedding, input_medication_memory, input_disease_embedding, input_proc_embedding, input_medication_self_mask, d_mask, p_mask):
