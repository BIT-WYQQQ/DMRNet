...
from models import DMRNet_wo_feature
...
def main(args):
    ...
    model = DMRNet_wo_feature(voc_size, ehr_adj, ddi_adj, dmo_adj, emb_dim=args.emb_dim, feature_size=args.feature_size, dmo_alpha=args.dmo_alpha, device=device)
